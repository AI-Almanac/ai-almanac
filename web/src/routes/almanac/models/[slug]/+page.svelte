...
<svelte:head>
	<title>{model.name} | Almanac of Weather Models</title>
	<meta name="description" content={model.summary} />
</svelte:head>

<main class="detail">
	<a class="back-link" href="/almanac#models">Back to model families</a>
	<section class="detail-hero">
		<p class="eyebrow">{model.modelType}</p>
		<h1>{model.name}</h1>
